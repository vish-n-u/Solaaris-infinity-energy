...
const systems = [
  {
    ...
    description:
      "Connected to the utility grid. Excess power is exported back, earning you credits. No battery required — most cost-effective option.",
  ...
  },
  {
    ...
    description:
      "Best of both worlds — connected to the grid with battery backup for power cuts. Store excess solar energy and use it at night.",
    bestFor: "Areas with frequent power outages",
    pros: ["24/7 power availability", "Battery backup", "Maximum self-consumption"],
    color: "from-solar-gold/10 to-solar-gold-dark/5",
    borderColor: "border-solar-gold/30",
    badgeColor: "bg-solar-gold/10 text-solar-gold-light",
    icon: "⚡",
    popular: true,
  },
  {
    ...
    description:
      "Completely independent from the utility grid. Runs entirely on solar + battery. Ideal where grid connection is unavailable.",
          ...
          {systems.map((system, i) => (
            ...
            >
              ...
              <div>
                ...
                <span
                  className={`inline-block text-xs font-semibold px-3 py-1 rounded-full mb-2 ${system.badgeColor}`}
                >
                  {system.subtitle}
                </span>
              ...
              <div className="flex flex-col gap-2">
                {system.pros.map((pro) => (
                  <div key={pro} className="flex items-center gap-2.5">
                    <svg
                      className="w-4 h-4 text-solar-gold flex-shrink-0"
                      fill="none"
                      viewBox="0 0 16 16"
                    >
